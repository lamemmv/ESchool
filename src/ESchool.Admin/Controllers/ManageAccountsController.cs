...
namespace ESchool.Admin.Controllers
{
    ...
    {
        private readonly ILogger<ManageAccountsController> _logger;
        ...
        public ManageAccountsController(
            ILogger<ManageAccountsController> logger,
        ...
        [HttpGet("{id}"), Authorize(Policy = ApiClaimTypes.ManageAccountsRead)]
