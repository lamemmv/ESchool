...
//            await SeedQuestionsVanHocAsync(qtagDbSet, questionDbSet);
//            await SeedQuestionsSinhHocAsync(qtagDbSet, questionDbSet);
...
//        private async Task<int> SeedQuestionsSinhHocAsync(DbSet<QTag> qtagDbSet, DbSet<Question> questionDbSet)
//        {
...
//        private async Task<int> SeedQuestionsLichSuAsync(DbSet<QTag> qtagDbSet, DbSet<Question> questionDbSet)
//        {
